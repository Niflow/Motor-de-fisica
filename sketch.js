...
var angulo=60;
var raio = 20;
var prateleira,pedraMenor,raioPedraMenor= 10;
// var wedge;
// var poly;
...
function setup() {
  ...
  pedraMenor=Objetos.circle(300, 20, raioPedraMenor, {restitution:0.85});
  Mundo.add(mundo, pedraMenor);

  prateleira=Objetos.rectangle(300, 200, 200, 20,opcoes_chao);
  Mundo.add(mundo, prateleira);
...
function draw() 
{
  ...
  ellipse(pedraMenor.position.x,pedraMenor.position.y,raioPedraMenor);

  rect(prateleira.position.x, prateleira.position.y,200,20);
}
